  ...
  return (
    <div className="mb-6">
      <div className="flex justify-center items-center gap-4 border-b-2 border-main print:border-black font-extrabold uppercase text-[0.9rem] pb-1 mb-4">
        ...
        <span
          className="font-[Jameel_Noori_Nastaleeq] text-[0.9rem] print:text-[1.1rem]"
          dir="rtl"
        >
          حصہ معروضی
        </span>
      ...
      <div className="flex justify-between items-center border-b border-dashed border-border print:border-black pb-2 mb-3">
        <div className="flex-1 text-left text-[0.9rem]">
          <strong className="mr-1">Q.1</strong> Choose the correct answer.
        </div>
        ...
        <div
          ...
          dir="rtl"
        >
          <strong className="ml-1">سوال نمبر 1:</strong> درست جواب کا انتخاب
          کریں۔
        </div>
        {isManualMode && (
          <button
        ...
        {mcqs.map((q, i) => (
          ...
          >
            ...
            <div className="flex gap-2 w-full items-baseline">
              <span className="font-extrabold min-w-5 text-[0.7rem]">
                {i + 1}.
              </span>
              <div className="flex-1 text-left text-[0.9rem]">
                {isManualMode ? (
            ...
            {q.options && (
              <div className="grid grid-cols-2 md:grid-cols-4 print:grid-cols-4 gap-x-4 gap-y-2 mt-1 pl-6 w-full">
                {q.options.map((opt, idx) => (
                  ...
                  >
                    <span className="font-bold text-[0.75rem] opacity-90">
                      ({String.fromCharCode(65 + idx)})
                    </span>
                    <div className="flex gap-1 items-baseline truncate">
                      <span className="font-medium text-[0.8rem] text-left">
                        {isManualMode ? (
                          <EditableField
                            isSmall
                            value={opt.en || ""}
                      ...
                      <span className="font-[Jameel_Noori_Nastaleeq] text-[0.9rem] print:text-[1rem] dir-rtl before:content-['('] before:ml-0.5 after:content-[')'] after:mr-0.5">
                        {isManualMode ? (
                          <EditableField
                            isSmall
                            isUrdu
