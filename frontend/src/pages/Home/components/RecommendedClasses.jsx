      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-4 lg:gap-6 max-w-4xl mx-auto">
          {classes.map((className, index) => (
            <div
              key={index}
              className="group relative flex items-center justify-center min-w-35 sm:min-w-45 w-full sm:w-auto px-6 py-4 bg-pill-bg/50 backdrop-blur-md border border-border rounded-2xl cursor-pointer transition-all duration-300 ease-out hover:-translate-y-1 hover:border-accent-1/50 hover:bg-pill-bg hover:shadow-lg hover:shadow-accent-1/10"
            >
